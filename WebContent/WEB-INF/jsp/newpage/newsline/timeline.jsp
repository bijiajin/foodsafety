...
<base href="<%=basePath%>">
	...
	<!-- 时间轴 -->
	<link rel="<%=basePath%>static/css/timeline.css">
...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<div id="main-content" class="clearfix">
			...
			<div>
				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="App/tab.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
			</div>
